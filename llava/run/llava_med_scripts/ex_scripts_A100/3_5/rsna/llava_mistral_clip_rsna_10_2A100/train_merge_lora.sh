...
###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/ex_scripts_A100/3_5/rsna/llava_mistral_clip_rsna_10_2A100/train_merge_lora.sh
 # @Description: 
### 
...
deepspeed train/clip_train_mem.py \
    ...
    --version v1 \
    --data_path ./data/fine_tuning/rsna/rsna_train_10.json \
