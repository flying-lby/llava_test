...
python -m llava.run.eval.eval_classify \
    --model-path /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava_mistral_chest_xray-A100-version1_3_5 \
    --result-folder ./result/experiments/Ex_A100/2025_3_5/chest_xray/chest_xray_1_classify.txt \
