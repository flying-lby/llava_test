...
python -m llava.run.eval.eval_classify \
    --model-path /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava_mistral_siim-A100-version10_3_5 \
    --result-folder ./result/experiments/Ex_A100/2025_3_5/siim/siim_10_classify.txt \
