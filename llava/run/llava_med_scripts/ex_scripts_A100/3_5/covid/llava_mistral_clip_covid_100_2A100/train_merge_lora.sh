...
###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/ex_scripts_A100/3_5/covid/llava_mistral_clip_covid_100_2A100/train_merge_lora.sh
 # @Description: 
### 
...
deepspeed train/clip_train_mem.py \
    ...
    --version v1 \
    --data_path ./data/fine_tuning/covid/covid_train_100.json \
    ...
    --bf16 True \
    --mis_mlp_lr 2e-5 \
    --output_dir /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava-lora-covid-A100-version100_3_5 \
    --num_train_epochs 10 \
...
python -m llava.run.train.clip_merge_lora_weights \
    --model-path /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava-lora-covid-A100-version100_3_5 \
    --model-base /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava_mistral_new_clip_a100_version1_2_9 \
    --save-model-path /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava_mistral_covid-A100-version100_3_5 \
    --Imgcls_count 4 \
    --Txtcls_count 8 \
    --hidden_dim 1024 \
    --output_dim 4096 \
