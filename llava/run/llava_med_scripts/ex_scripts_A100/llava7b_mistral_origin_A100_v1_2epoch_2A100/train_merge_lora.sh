...
###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/ex_scripts_A100/llava7b_mistral_origin_A100_v1_2epoch_2A100/train_merge_lora.sh
 # @Description: 
### 
...
deepspeed train/train_mem.py \
    ...
    --model_name_or_path /mnt/nlp-ali/usr/huangwenxuan/home/official_llava/llava_mistral_7b_official \
    --version v1 \
