###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/ex_scripts_A100/llava_mistral_clip_A100_v1_img4_txt8_lr2e5_layer2_2epoch_2A100/eval_chestxray_classify.sh
 # @Description: 
### 
