...
python -m llava.run.eval.eval_classify \
    --model-path /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava_mistral_new_clip_a100_version4_3_3 \
    --result-folder ./result/A100/2025_3_3/llava_mistral_clip_A100_v4_book1_cat_t7_2epoch_2A100/ \
