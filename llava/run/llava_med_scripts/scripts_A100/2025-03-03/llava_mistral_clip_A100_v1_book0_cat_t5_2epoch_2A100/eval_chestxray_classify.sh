...
python -m llava.run.eval.eval_classify \
    --model-path /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava_mistral_new_clip_a100_version1_3_3 \
    --result-folder ./result/A100/2025_3_3/llava_mistral_clip_A100_v1_book0_cat_t5_2epoch_2A100/ \
