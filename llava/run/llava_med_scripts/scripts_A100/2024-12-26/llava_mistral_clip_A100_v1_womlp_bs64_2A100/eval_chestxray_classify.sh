###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/scripts_A100/llava_mistral_clip_A100_v1_womlp_bs64_2A100/eval_chestxray_classify.sh
 # @Description: 
### 
...
python -m llava.run.eval.eval_classify \
    ...
    --result-file ./result/A100/llava_mistral_clip_A100_v1_womlp_bs64_2A100/Chest_Xray_classify.txt \
