...
###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/scripts_A100/2025-01-15/llava_mistral_clip_A100_v5_llava1.6_chest_1epoch_2A100/train_merge_lora.sh
 # @Description: 
### 
...
#     --bf16 True \
#     --mis_mlp_lr 2e-5 \
#     --output_dir /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava-lora-new-clip-A100-version5_1_15 \
#     --num_train_epochs 1 \
...
python -m llava.run.train.merge_lora_weights \
    --model-path /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava-lora-new-clip-A100-version5_1_15 \
    --model-base /mnt/nlp-ali/usr/huangwenxuan/home/official_llava/llava-v1.6-7b \
    --save-model-path /mnt/nlp-ali/usr/huangwenxuan/home/zijie_ali/libangyan/checkpoints/llava_mistral_new_clip_a100_version5_1_15 \
    --ncls_count 4 \
    --hidden_dim 1024 \
    --output_dim 4096 \
    --mlp_type 0 \
