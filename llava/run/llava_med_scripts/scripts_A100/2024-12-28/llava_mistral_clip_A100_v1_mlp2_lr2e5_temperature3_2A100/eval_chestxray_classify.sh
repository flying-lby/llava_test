###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/scripts_A100/2024-12-28/llava_mistral_clip_A100_v1_mlp2_lr2e5_temperature3_2A100/eval_chestxray_classify.sh
 # @Description: 
### 
...
python -m llava.run.eval.eval_classify \
    --model-path ./checkpoints/llava_mistral_new_clip_a100_version9_12_28 \
