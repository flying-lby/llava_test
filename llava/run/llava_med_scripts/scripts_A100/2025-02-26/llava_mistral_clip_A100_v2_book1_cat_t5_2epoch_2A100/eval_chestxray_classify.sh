###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/scripts_A100/2025-02-26/llava_mistral_clip_A100_v2_book1_cat_t5_2epoch_2A100/eval_chestxray_classify.sh
 # @Description: 
### 
...
python -m llava.run.eval.eval_classify \
    ...
    --result-file ./result/A100/2025_2_26/llava_mistral_clip_A100_v2_book1_cat_t5_2epoch_2A100/Chest_Xray_classify.txt \
