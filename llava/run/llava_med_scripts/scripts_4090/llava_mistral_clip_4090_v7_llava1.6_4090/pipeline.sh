...
###
 ...
 # @FilePath: /llava_med/LLaVA-Med/llava/run/llava_med_scripts/scripts_4090/llava_mistral_clip_4090_v7_llava1.6_4090/pipeline.sh
 # @Description: 
### 
...
deepspeed train/train_mem.py \
    ...
    --model_name_or_path /srv/lby/llava-v1.6-mistral-7b \
    --version v1 \
    ...
    --bf16 True \
    --mis_mlp_lr 5e-4 \
    --output_dir ./checkpoints/llava-lora-new-clip-v7 \
    --num_train_epochs 1 \
