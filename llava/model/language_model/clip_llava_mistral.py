...
from llava.model.clip_modeling_mistral import (
    MistralConfig,
    MistralModel,
    MistralForCausalLM
)
...
class ClipLlavaMistralConfig(MistralConfig):
    model_type = "clip_llava_mistral"
...
class LlavaMistralModel(LlavaMetaModel, MistralModel):
    config_class = ClipLlavaMistralConfig
...
class ClipLlavaMistralForCausalLM(MistralForCausalLM, LlavaMetaForCausalLM):
    config_class = ClipLlavaMistralConfig
    ...
    def __init__(self, config):
        ...
        if hasattr(config, "sparse_config") and config.sparse_config is not None:
            ...
            self.use_cat = config.sparse_config["use_cat"]
...
AutoConfig.register("clip_llava_mistral", ClipLlavaMistralConfig)
AutoModelForCausalLM.register(ClipLlavaMistralConfig, ClipLlavaMistralForCausalLM)
